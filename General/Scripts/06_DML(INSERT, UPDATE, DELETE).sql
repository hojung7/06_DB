...
SELECT COUNT(*)
FROM EMPLOYEE2;  -- 전체 행의 개수 23행 카운트
...
INSERT INTO EMPLOYEE2(EMP_NAME, EMP_ID, 
								EMP_NO, EMAIL, PHONE, DEPT_CODE, 
...
WHEN MATCHED THEN -- 증벅 확인용 KEY가 매치되면 (일치하면)
UPDATE SET -- 수정하겠다
